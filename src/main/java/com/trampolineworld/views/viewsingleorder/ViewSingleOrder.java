...
public class ViewSingleOrder extends HorizontalLayout implements BeforeEnterObserver {
	...
	private Paragraph firstNameParagraph, lastNameParagraph, phoneNumberParagraph, emailParagraph, orderDescriptionParagraph, measurementsParagraph, subtotalParagraph, totalParagraph, dateParagraph, completeParagraph; 
	private Label firstNameLabel, lastNameLabel, phoneNumberLabel, emailLabel, descriptionLabel, measurementsLabel, subtotalLabel, totalLabel, dateLabel, completeLabel;
    ...
    public ViewSingleOrder(TrampolineOrderService trampolineOrderService) {
